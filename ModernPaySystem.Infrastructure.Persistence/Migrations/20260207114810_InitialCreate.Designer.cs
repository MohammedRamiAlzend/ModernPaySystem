...
namespace ModernPaySystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260207114810_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModernPaySystem.Domain.Entities.SharedEntities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("ModernPaySystem.Domain.Entities.SharedEntities.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ModernPaySystem.Domain.Entities.SharedEntities.RolePermission", b =>
                {
                    b.HasOne("ModernPaySystem.Domain.Entities.SharedEntities.PermissionEntity", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModernPaySystem.Domain.Entities.SharedEntities.Role", "Role")
                        .WithMany("RolePermissions")
