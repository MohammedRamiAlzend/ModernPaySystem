...
// مثال عن كيفية استخدام الاستراتيجيات
// 1. إنشاء الـ Hook الخاص بجلب البيانات
// سنفترض أننا نريد جلب العقود كبيانات بالغة الأهمية (CRITICAL) لضمان تحديثها دائماً عند فشل الشبكة أو العودة للنافذة:
// src/hooks/use-contracts.ts
// import { useQuery } from '@tanstack/react-query';
// import api from '@/api/baseApi';
// import { UpdateStrategy, QUERY_STRATEGIES } from '@/constants/query-strategies';
...
//     },
//      تطبيق إعدادات الاستراتيجية الحرجة (3 محاولات، تحديث فوري)
//     ...QUERY_STRATEGIES[UpdateStrategy.CRITICAL],
//   });
// };


// 2. استخدام الـ Hook داخل المكون (Component)
// الآن يمكنك استخدامه في صفحة العقود بكل بساطة:
// src/pages/contracts-page.tsx
