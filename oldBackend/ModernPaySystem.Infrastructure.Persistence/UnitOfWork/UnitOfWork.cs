    ...
    IHttpContextServiceManager httpContextServiceManager) : IUnitOfWork
{
    ...
    public IRepositoryBase<RequestRelation, Guid> RequestRelations =>
        _requestRelations ??= new RepositoryBase<RequestRelation, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<RequestRelation, Guid>>(), _httpContextServiceManager);
    ...
    public IRepositoryBase<DepartmentArchiveLeader, Guid> DepartmentArchiveLeaders =>
        _departmentArchiveLeaders ??= new RepositoryBase<DepartmentArchiveLeader, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<DepartmentArchiveLeader, Guid>>(), _httpContextServiceManager);
    ...
    public IRepositoryBase<Document, Guid> Documents =>
        _documents ??= new RepositoryBase<Document, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<Document, Guid>>(), _httpContextServiceManager);
    ...
    public IRepositoryBase<ArchiveConfig, Guid> ArchiveConfigs =>
        _archiveConfigs ??= new RepositoryBase<ArchiveConfig, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<ArchiveConfig, Guid>>(), _httpContextServiceManager);

    public IRepositoryBase<FolderIcon, Guid> FolderIcons =>
        _folderIcons ??= new RepositoryBase<FolderIcon, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<FolderIcon, Guid>>(), _httpContextServiceManager);

    public IRepositoryBase<RequestAuditLog, Guid> RequestAuditLogs =>
        _requestAuditLogs ??= new RepositoryBase<RequestAuditLog, Guid>(_dbContext, _loggerFactory.CreateLogger<RepositoryBase<RequestAuditLog, Guid>>(), _httpContextServiceManager);
