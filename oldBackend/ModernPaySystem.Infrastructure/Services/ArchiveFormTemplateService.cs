...
public class ArchiveFormTemplateService(IUnitOfWork unitOfWork, ILogger<ArchiveFormTemplateService> logger) : IArchiveFormTemplateService
{
    public async Task<Result<IEnumerable<ArchiveFormTemplateDto>>> GetAllAsync()
    {
        ...
        {
            logger.LogError(ex, "Error fetching archive form templates");
    ...
    public async Task<Result<PagedList<ArchiveFormTemplateDto>>> GetPagedAsync(int page, int pageSize)
    {
        ...
        {
            logger.LogError(ex, "Error fetching paged archive form templates, page: {Page}, size: {PageSize}", page, pageSize);
            return ApplicationErrors.InternalServerError;
        }
    }
    ...
    public async Task<Result<ArchiveFormTemplateDto>> GetByIdAsync(Guid id)
    {
        ...
        {
            logger.LogError(ex, "Error fetching archive form template {FormId}", id);
            return ApplicationErrors.InternalServerError;
        }
    }
    ...
    public async Task<Result<ArchiveFormTemplateDto>> GetByNameAsync(string name)
    {
        ...
        {
            logger.LogError(ex, "Error fetching archive form template by name {FormName}", name);
            return ApplicationErrors.InternalServerError;
        }
    }
    ...
    public async Task<Result<ArchiveFormTemplateDto>> CreateAsync(CreateDynamicFormTemplateDto dto)
    {
        ...
        {
            logger.LogError(ex, "Error creating archive form template");
            return ApplicationErrors.InternalServerError;
        }
    }
    ...
    public async Task<Result<ArchiveFormTemplateDto>> UpdateAsync(Guid id, UpdateDynamicFormTemplateDto dto)
    {
        ...
        {
            logger.LogError(ex, "Error updating archive form template {FormId}", id);
            return ApplicationErrors.InternalServerError;
        }
    }
    ...
    public async Task<Result<bool>> DeleteAsync(Guid id)
    {
        ...
        {
            logger.LogError(ex, "Error deleting archive form template {FormId}", id);
            return ApplicationErrors.InternalServerError;
        }
    }
}
