...
> [!WARNING]
> كل مرحلة لها مرفقاتها الخاصة المنفصلة. لا يتم "توريث" الصور بين المراحل تلقائياً.
...
| **الرد على الإحالات** | ✅ تظهر (بيانات الطلب المحال) | ❌ لم تُنشأ بعد | ⚠️ ملاحظات الإحالة فقط |
| **الإحالات الصادرة** | ✅ تظهر (بيانات الطلب) | ❌ لا تُعرض | ⚠️ ملاحظات فقط |
