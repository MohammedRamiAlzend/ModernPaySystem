...
namespace ModernPaySystem.Module.Archive.Infrastructure.Interceptors;

public class ArchiveAuditInterceptor(IHttpContextServiceManager httpContextServiceManager) : SaveChangesInterceptor
{
