    ...
    ILogger<DepartmentsController> logger) : ControllerBase
{
    ...
    {
        logger.LogInformation("Fetching archive leaders for department: {DepartmentId}", id);
    ...
    {
        logger.LogInformation("Assigning archive leader: {UserId} to department: {DepartmentId}", userId, id);
    ...
    {
        logger.LogInformation("Unassigning archive leader: {UserId} from department: {DepartmentId}", userId, id);
