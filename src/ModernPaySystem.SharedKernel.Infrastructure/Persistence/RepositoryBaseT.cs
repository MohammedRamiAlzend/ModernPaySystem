...
namespace ModernPaySystem.SharedKernel.Infrastructure.Persistence;

public class RepositoryBase<TEntity, TKey>(DbContext dbcontext,
    ILogger<RepositoryBase<TEntity, TKey>> logger) : IRepositoryBase<TEntity, TKey>
